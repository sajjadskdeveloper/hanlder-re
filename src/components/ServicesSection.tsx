  ...
  const services = [
    {
      ...
      description: 'Expert guidance through the entire home buying and selling process with market analysis and negotiation support.',
    ...
    },
    {
      ...
      description: 'Strategic investment advice and portfolio management for real estate investors.',
    ...
    },
    {
      ...
      description: 'Specialized services for commercial property transactions and development projects.',
      features: ['Site Selection', 'Lease Negotiation', 'Development Planning', 'Tenant Relations']
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Comprehensive legal support and documentation services for all real estate transactions.',
      features: ['Contract Review', 'Title Services', 'Legal Compliance', 'Documentation']
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Virtual Tours & Marketing',
      description: 'Modern marketing solutions including virtual tours, professional photography, and digital marketing.',
      features: ['Virtual Tours', 'Professional Photography', 'Digital Marketing', 'Social Media']
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <button className="mt-6 w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                Learn More
              </button>
            </div>
          ))}
